export class View {
    ...
    setSamplingParametersAvailability(isAvailable) {
        if (isAvailable) {
            return;
        }

        // A API web moderna usa os valores de amostragem definidos pelo Chrome.
        // Os campos continuam visíveis para preservar o conteúdo didático da aula.
        this.elements.temperature.disabled = true;
        this.elements.topK.disabled = true;
        this.elements.temperature.title = 'Parâmetro legado indisponível nesta versão do Chrome.';
        this.elements.topK.title = 'Parâmetro legado indisponível nesta versão do Chrome.';
    }
